...
module.exports = {
    ...
    execute(message, args, Discord, client){
        ...
        if(message.author.id !== config.ownerID){ message.channel.send("You're not the owner of the bot..."); return;}
        else{
        ...
        .setDescription(`https://api.hypixel.net/player?uuid=11456473-de28-4d36-aa7b-4150fe7859ab&key=${config.hypixelAPIKey}`)
